...
let someNumbers = [
  17, 8, 1, 12, 2, 5, 4, 3, 10, 14, 7, 9, 13, 6, 16, 11, 15, 12,
];
...
); // b-a turns the number to accending other
...
const week = prompt(
  " Using the range 1 to 7, Monday is 1 and Sunday is 7, what day is today ? "
);
if (week >= 1 && week < 5) {
